...
// The mobile layout pins the cards (wrapping them in a pin-spacer). Reverting
// must happen synchronously before React unmounts these nodes on navigation,
// otherwise React throws "node to be removed is not a child of this node".
// A layout effect cleanup runs in time; a plain useEffect cleanup does not.
...
export default function ServiceCards() {
  useIsomorphicLayoutEffect(() => {
    ...
    // Scope every animation/ScrollTrigger created below so ctx.revert() on
    // unmount kills them all (including the mobile pin) and restores the DOM.
